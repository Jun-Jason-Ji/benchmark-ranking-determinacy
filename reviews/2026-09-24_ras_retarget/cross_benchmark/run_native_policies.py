...
base = env.unwrapped
task_object = base.cube if hasattr(base, 'cube') else base.obj
initial = dict(qpos=tensor(base.agent.robot.get_qpos()), cube_pose=tensor(task_object.pose.raw_pose))
if hasattr(base,'goal_site'): initial['goal_pose']=tensor(base.goal_site.pose.raw_pose)
elif hasattr(base,'goal_region'): initial['goal_pose']=tensor(base.goal_region.pose.raw_pose)
