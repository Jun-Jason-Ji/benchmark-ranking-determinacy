...
- The manuscript is **46 pages**, with a **208-word abstract** and six keywords. It was rebuilt
...
- The cover letter is approximately **567 words**, focused on three empirical contributions,
...
- Both eggplant operating points have all six evaluated conditions. Their set envelopes abstain;
  the paired operating-point effect remains statistically unresolved. The unused fitted-spoon
  extension is outside the frozen manuscript evidence scope.
...
- The final companion data/code snapshot contains **16,812 source files / 16,817 package files**.
...
Do not deliver incomplete/superseded QA packages. Do not replace the final companion with a later
working-tree snapshot merely because an unrelated sweep has finished. Inclusion of historical
