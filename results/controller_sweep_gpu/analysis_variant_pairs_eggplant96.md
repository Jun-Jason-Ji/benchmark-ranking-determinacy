# Deployment-variant policy pairs (same 96 episode_ids per condition; duplicate records: keep first)
...
| octo-base | octo-base@hist1 | 96 | +0.010 | [-0.11, +0.12] | yes |
...
| octo-base | octo-small@hist1 | 96 | -0.094 | [-0.21, +0.02] | yes |
...
| octo-base@hist1 | octo-small@hist1 | 96 | -0.104 | [-0.22, +0.01] |  |
...
| octo-small | octo-small@hist1 | 96 | +0.115 | [-0.02, +0.24] |  |
...
point-estimate sign change across conditions for octo-base vs octo-small@hist1: { nominal: -0.09, iso_x0.25: +0.06, iso_x4.0: -0.06, force_x0.5: -0.08, fric_x0.4: +0.09, dens_x0.5: -0.09 }
